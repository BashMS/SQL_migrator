...
import (
	...
	domain "github.com/BashMS/SQL_migrator/pkg/domain"
...
func (_m *MockMigrateStorage) BeginTxMigration(ctx context.Context, migration domain.Migration, direction bool) (pgx.Tx, error) {
...
func (_m *MockMigrateStorage) GetMigrationsByDirection(ctx context.Context, isApplied bool) (map[uint64]domain.Migration, error) {
