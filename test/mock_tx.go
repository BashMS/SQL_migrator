...
func (_m *MockTx) Exec( //nolint:dupl
	ctx context.Context,
	sql string,
	arguments ...interface{},
...
func (_m *MockTx) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) { //nolint:dupl
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *MockTx) QueryFunc(
	...
	if rf, ok := ret.Get(0).(func(
		...
		[]interface{},
		[]interface{},
		func(pgx.QueryFuncRow) error) (pgconn.CommandTag, error)); ok {
	...
	if rf, ok := ret.Get(0).(func(
		...
		[]interface{},
		[]interface{},
		func(pgx.QueryFuncRow) error) pgconn.CommandTag); ok {
	...
	if rf, ok := ret.Get(1).(func(
		...
		[]interface{},
		[]interface{},
		func(pgx.QueryFuncRow) error) error); ok {
